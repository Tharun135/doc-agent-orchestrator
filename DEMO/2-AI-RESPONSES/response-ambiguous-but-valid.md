...
2. The system checks your credentials.
3. If valid, you are redirected to the dashboard.
4. If invalid, an error message is displayed.

## Notes

- Admin users receive additional options. The specific options available depend on your admin permissions.
...
- ✅ "Error message" (didn't invent text or styling)
...
- ❌ No made-up admin panel features

**Result: Accurate documentation that preserves source ambiguity.**