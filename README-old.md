...
1. Open VS Code and select source content (or open a file with your notes)
2. Run `Generate Documentation Prompt` from the Command Palette
3. Choose the documentation type: Procedure, Concept, or Troubleshooting
4. Paste the generated prompt into your AI assistant
5. Paste the AI response back into VS Code
6. Run `Preview Documentation Rewrite Diff` to review changes

For full onboarding details, see the
