      ...
      <div class="footer-content">
        <div class="footer-left">
          ...
          <div class="author-tag">
            Developed by <a href="https://linkedin.com/in/tharun-sebastian" target="_blank" class="author-name">Tharun Sebastian</a>
          </div>
        </div>
            ...
            <div class="workflow-diagram">
              <svg class="workflow-svg" viewBox="0 0 700 120" id="manual-workflow-svg">
                ...
                <g id="svg-node-2" class="svg-node">
                  <rect x="200" y="30" width="100" height="60" rx="10" fill="transparent" stroke="var(--border)" stroke-width="1.5" />
